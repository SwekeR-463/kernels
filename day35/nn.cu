...
int main() {
    ...
    load_data("/home/sweker/work/cuda/day35/mnist_data/X_train.bin", X_train, TRAIN_SIZE * INPUT_SIZE);
    load_labels("/home/sweker/work/cuda/day35/mnist_data/y_train.bin", y_train, TRAIN_SIZE);
    load_data("/home/sweker/work/cuda/day35/mnist_data/X_test.bin", X_test, TEST_SIZE * INPUT_SIZE);
    load_labels("/home/sweker/work/cuda/day35/mnist_data/y_test.bin", y_test, TEST_SIZE);
