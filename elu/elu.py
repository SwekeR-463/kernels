...
for S, K in SKs:
    ...
    run_benchmark(lib.elu_fp32, x, "f32", y)
    run_benchmark(torch_elu, x, "f32_th", y)
    print("-" * 85)
    x_f16 = x.half().contiguous()
    y_f16 = y.half().contiguous()
    run_benchmark(lib.elu_fp16, x_f16, "f16", y_f16)
    run_benchmark(lib.elu_fp16x2, x_f16, "f16x2", y_f16)
    run_benchmark(lib.elu_fp16x8_pack, x_f16, "f16x8pack", y_f16)
